...
class User33Controller extends Controller
{
    ...
    public function approve33($id)
    {
        $user_id = Crypt::decrypt($id);
        DetailData::create(['id_user' => $user_id]);
        User::where('id', $user_id)->update(['is_aktif' => '1']);
        return redirect('/admin33')->with(['approved' => 'User berhasil diapprove!']);
    }
    public function edit33()
    {
        $agama = Agama::get();
        $data = DetailData::where('id_user', Auth::user()->id)->get();
    ...
    public function update33(Request $request)
    {
        ...
        return redirect('/dashboard33')->with(['updated' => 'Detail data berhasil diupdate!']);
    }
    public function gantipass33()
    {
        return view('user.password');
    }
    public function updatepass33(Request $request)
    {
        ...
        return redirect('/dashboard33')->with(['password' => 'Password berhasil diganti!']);
    }
}