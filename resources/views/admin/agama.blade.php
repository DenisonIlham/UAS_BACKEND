                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/admin33/data-agama33/edit33/{{$item->id}}" class="text-success mx-2"><i
                                        class="fa fa-edit fa-lg"></i></a>
                                <a href="/admin33/data-agama33/delete33/{{$item->id}}" class="text-danger mx-2"><i
        ...
        <div class="modal fade" id="tambah-agama">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="/admin33/data-agama33/create33" method="POST">
                        @csrf
