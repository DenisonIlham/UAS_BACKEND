    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body row">
                ...
                <div class="col-md-4">
                    <form action="/admin33/dashboard33/update-foto-profil33" method="POST" class="form-horizontal"
                ...
                <table id="table" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href={{"/admin33/dashboard33/detail33/".Crypt::encrypt($item->id)}} class="btn
                                    btn-primary mx-1"><i class="fa fa-info-circle"></i> Detail</a>
                                @if ($item->is_aktif=='0')
                                <a href={{"/admin33/approve33/".Crypt::encrypt($item->id)}} class="btn btn-success
