        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
               ...
               with font-awesome or any other icon font library -->
                            <li class="nav-item @php if(\Request::path() == 'admin33/dashboard33')echo " menu-open"
                                @endphp">
                                <a href="/admin33/dashboard33" class="nav-link">
                            ...
                            <li class="nav-item @php if(\Request::path() == 'admin33/data-agama33')echo " menu-open"
                                @endphp">
                                <a href="/admin33/data-agama33" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="/logout33" class="nav-link">
